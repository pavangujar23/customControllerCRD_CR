...
import (
	...
	internalinterfaces "customControllerCRD_CR/pkg/client/informers/internalversion/internalinterfaces"
	internalversion "customControllerCRD_CR/pkg/client/listers/v1alpha1/internalversion"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Pavangujar().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Pavangujar().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&v1alpha1.Kluster{},
		resyncPeriod,
