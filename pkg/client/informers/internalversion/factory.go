...
import (
	...
	v1alpha1 "customControllerCRD_CR/pkg/client/informers/internalversion/v1alpha1"
	reflect "reflect"
	sync "sync"
	time "time"
...
type SharedInformerFactory interface {
	...
	Pavangujar() v1alpha1.Interface
}

func (f *sharedInformerFactory) Pavangujar() v1alpha1.Interface {
