...
import (
	"context"
	pavangujardevv1alpha1 "customControllerCRD_CR/pkg/apis/pavangujar.dev/v1alpha1"
	versioned "customControllerCRD_CR/pkg/client/clientset/versioned"
	internalinterfaces "customControllerCRD_CR/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "customControllerCRD_CR/pkg/client/listers/pavangujar.dev/v1alpha1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.PavangujarV1alpha1().Klusters(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.PavangujarV1alpha1().Klusters(namespace).Watch(context.TODO(), options)
			},
		},
		&pavangujardevv1alpha1.Kluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *klusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pavangujardevv1alpha1.Kluster{}, f.defaultInformer)
}
